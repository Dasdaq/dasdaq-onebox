...
namespace Dasdaq.Dev.Agent.Services
{
    public class AccountService
    {
        public void CreateAccount(string name)
        {
            ...
            var startInfo = new ProcessStartInfo("/opt/eosio/bin/cleos", $"-u http://0.0.0.0:8888 --wallet-url http://0.0.0.0:8888 create account eosio {name} {privateKey} {privateKey}");
